...
| Rust 测试 | `cargo test --lib -- --skip libre_provider_completes_a_loopback_http_request --skip openai_provider_sends_bearer_auth_over_loopback_http` | 75 passed；2 项 localhost mock 因当前沙箱禁止监听端口而过滤，见独立回环证据 |
